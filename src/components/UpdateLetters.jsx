    ...
    <div className="mb-3">
      ...
      <div className="flex">
        <div className="flex">
          ...
          <div className="mr-3">
            <div data-tooltip-id="hex-tooltip" data-tooltip-content={displayHex((temp1 + temp2)%(2**32))}>
              { decimalToBinary(((temp1 + temp2) >>> 0)%(2**32)).padStart(32, '0') }
            </div>
            { execute &&
              <div>
            ...
            <div data-tooltip-id="hex-tooltip" data-tooltip-content={displayHex(a)} className="text-fuchsia-500">
            ...
            <div data-tooltip-id="hex-tooltip" data-tooltip-content={displayHex(b)} className="text-lime-500">
            ...
            <div data-tooltip-id="hex-tooltip" data-tooltip-content={displayHex(c)} className="text-orange-500">
            ...
            <div data-tooltip-id="hex-tooltip" data-tooltip-content={displayHex(((d + temp1) >>> 0)%(2**32))}>
            ...
            <div data-tooltip-id="hex-tooltip" data-tooltip-content={displayHex(e)} className="text-green-500">
            ...
            <div data-tooltip-id="hex-tooltip" data-tooltip-content={displayHex(f)} className="text-red-500">
            ...
            <div data-tooltip-id="hex-tooltip" data-tooltip-content={displayHex(g)} className="text-indigo-500">
