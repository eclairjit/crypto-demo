	...
	return (
		<Fragment>
			...
			<div class="h-screen w-full bg-.gray-800 relative flex overflow-hidden">
				<aside
					class="h-full w-64 flex flex-col space-y-10 items-center justify-center relative bg-gray-800 text-white"
					style={{
						boxShadow:
          ...
          <path
              ...
              />
				...
				<div class="w-full h-full flex flex-col justify-between">
					...
					<div className="parent-container mx-4 my-4 overflow-y-scroll">
						{children}
					</div>
				</div>
			</div>
